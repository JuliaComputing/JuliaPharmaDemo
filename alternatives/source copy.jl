...
begin using Downloads: download
using SBMLToolkit, Graphs, SimpleWeightedGraphs, StatsPlots, InformationMeasures, GraphPlot, DataFrames, PumasQSP, ModelingToolkit, DifferentialEquations
end
...
begin
	...
	print(ModelingToolkit.defaults(odesys)[k1])
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "9a8e0dd6d4421489e9e686776f23b9753aaca556"
